...
class SocialAccountController extends Controller
{
    ...
    protected function syncTikTok(SocialAccount $socialAccount): \Illuminate\Http\JsonResponse
    {
        try {
            ...
            // 2. Ambil daftar video terbaru dari akun TikTok pengguna (dibatasi 1 video agar hemat kuota RapidAPI)
            $videos = $this->tikTokService->getUserVideos($socialAccount->handle, 1);
